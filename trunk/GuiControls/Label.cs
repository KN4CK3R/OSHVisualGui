...
namespace OSHVisualGui.GuiControls
{
    ...
    public class Label : ScalableControl
    {
		...
		public string Text { get { return text; } set { text = value == null ? string.Empty : value; if (AutoSize) { base.Size = TextRenderer.MeasureText(text, Font, new Size(1000, 1000), TextFormatFlags.NoPadding); } } }
        public override Size Size { get { return base.Size; } set { if (!AutoSize) { base.Size = value; } } }
		public override Font Font { get { return base.Font; } set { base.Font = value; if (AutoSize) { base.Size = TextRenderer.MeasureText(text, Font, new Size(1000, 1000), TextFormatFlags.NoPadding); } } }
		public override bool AutoSize { get { return base.AutoSize; } set { base.AutoSize = value; if (AutoSize) { base.Size = TextRenderer.MeasureText(text, Font, new Size(1000, 1000), TextFormatFlags.NoPadding); } } }
        #endregion
